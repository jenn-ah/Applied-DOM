(function (window) {
  ...
  function setMyLightGreen() {
    ...
    let lightGreenVar = document.getElementById(lightId);
    lightGreenVar.className = 'light-green';
  };
  ...
  function setMyLightClass(event, desiredClass) {
    let lightId = this.dataset.lightId;
    let desClass = document.getElementById(lightId);
    desClass.className = desiredClass;
   ...
   */
   ...
   btn13.addEventListener('click', function (event) {
    ...
    setMyLightClass.call(btn13, event, 'light-green');
   });
   ...
   */
    ...
    btn14.addEventListener('click', function () {
      ...
      setMyLightGreen.call(btn14, event, 'light-green');
    });
